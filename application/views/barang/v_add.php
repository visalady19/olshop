    ...
    <!-- /.card-header -->
        <div class="card-body">
            ...
            <div class="col-sm-4">
                ...
                <input type="number" name="berat" min="0" class="form-control" placeholder="Berat Satuan Gram" value="<?= set_value('berat') ?>">
                </div>
            </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input name="gambar" type="file" class="form-control" id="preview_gambar" required><br>
