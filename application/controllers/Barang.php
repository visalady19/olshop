...
class Barang extends CI_Controller {
    ...
    public function add()
    {
        ...
        $this->form_validation->set_rules('berat', 'Berat Barang', 'required', array('required' => '%s Harus Diisi !!!'));
        $this->form_validation->set_rules('deskripsi', 'Deskripsi Barang', 'required', array('required' => '%s Harus Diisi !!!'));
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (!$this->upload->do_upload($field_name)) {
                ...
                $config['source_file'] = './assets/gambar/'.$upload_data['uploads']['file_name'];
    ...
    public function edit( $id_barang = NULL )
    {
        ...
        $this->form_validation->set_rules('berat', 'Berat Barang', 'required', array('required' => '%s Harus Diisi !!!'));
        $this->form_validation->set_rules('deskripsi', 'Deskripsi Barang', 'required', array('required' => '%s Harus Diisi !!!'));
        $this->form_validation->set_rules('stok', 'Stok Barang', 'required', array('required' => '%s Harus Diisi !!!'));
